...
var ICS = (function() {
    function ICS(filename, dtstamp, dtstart, dtend, summary, description, location, descriptionalt) {
        this.dtstamp = {};
        this.dtstart = {};
        this.dtend = {};
    ...
    ICS.prototype.formatDate = function(dateUTC) {
        ...
        var _a = this.formatDateBuilder(dateUTC),
            year = _a[0],
            month = _a[1],
            day = _a[2],
            hours = _a[3],
